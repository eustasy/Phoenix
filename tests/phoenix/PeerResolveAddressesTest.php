...
class PeerResolveAddressesTest extends PhoenixTestCase {
	...
	public static function setUpBeforeClass(): void {
		...
		require_once self::$settings['functions'].'function.parse.ipv4.php';
		require_once self::$settings['functions'].'function.parse.ipv6.php';
		require_once self::$settings['functions'].'function.peer.resolve.addresses.php';
	}
