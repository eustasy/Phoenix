...
//
// It stops at the first matching row rather than aggregating the ledger to
// decide whether to show a button: with the `geo` index (event, country,
// info_hash) that is a seek, not a scan.
//
