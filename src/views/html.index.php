...
function view_index_html(array $index, bool $show_meta = false, string $version = ''): string
{
	...
	<p class="dim" style="font-size:var(--font-size-sm);margin-top:var(--space-4)">Health is the seeder share of each swarm. Click a hash to copy it. Filtering and sorting are progressive enhancements &mdash; the page works without JavaScript.</p>';
